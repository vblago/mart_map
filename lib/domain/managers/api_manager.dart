...
class ApiManager {
  ...
  List<Point> getPoints() {
    ...
    points.add(new Point("Rica Mare", "AYF 173", 4.5,
        ...
        ["Куртки", "Сумки", "Туфли", "Блузки", "Сапоги"], [0, 2, 5, 6], "+38 (095) 345 2345", 50.003098, 36.306834));

    points.add(new Point("ООО «ЗимаЛето»", "BDJ 384", 4.5,
        ...
        ["Куртки"], [0, 2], "+38 (095) 345 2345", 50.003622, 36.306378));

    points.add(new Point("Фабрика", "JDB 938", 3.5,
        ...
        ["Куртки", "Сумки", "Туфли", "Блузки", "Сапоги", "Ремешки"], [3, 7], "+38 (095) 345 2345", 50.003074, 36.306268));

    points.add(new Point("Де - Виктори", "NDG 362", 5,
        ...
        ["Куртки", "Ремешки"], [0], "+38 (095) 345 2345", 50.003403, 36.306072));

    points.add(new Point("Mirage Style", "LAF 375", 4,
        "http://mirage-style.com.ua/wa-data/public/site/img/IMG_2476-1.JPG.pagespeed.ce.dq9HtYcPgO.jpg",
        "Наша команда дизайнеров тщательно отслеживает последние модные тенденции, ищет свежие стилевые решения и новые формы. "
            "Таким образом, одежда RicaMare всегда актуальна и современна, что прекрасные покупательницы не могут не оценить!",
        ["Куртки"], [6, 2], "+38 (095) 345 2345", 50.002791, 36.305629));

    points.add(new Point("B-planet", "MJG 735", 5,
        ...
        ["Куртки","Туфли", "Блузки", "Сапоги"], [5, 6], "+38 (095) 345 2345", 50.002813, 36.306485));

    points.add(new Point("UaMode", "AKN 23", 3,
        ...
        ["Сумки", "Сапоги", "Ремешки"], [4, 5], "+38 (095) 345 2345", 50.003369, 36.307075));
